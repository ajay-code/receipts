...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        receipt: __webpack_require__(228),
    ...
    methods: (_methods = {
        ...
        deleteMultipleReceipts: function deleteMultipleReceipts() {
            ...
            axios.get(this.scopeApi + '/receipts/force-delete/');
        ...
        restoreMultipleReceipts: function restoreMultipleReceipts() {
            ...
            axios.get(this.scopeApi + '/receipts/restore/');
...
var update = __webpack_require__(17)("c4d5450e", content, false);
