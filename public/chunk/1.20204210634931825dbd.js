...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__eventHub__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__eventHub___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__eventHub__);
throw new Error("Cannot find module \"momentjs\"");
...
/* harmony default export */ __webpack_exports__["default"] = (_data$props$computed$ = {
    data: function data() {
        return {
    ...
    createdAt: function createdAt() {
        return __WEBPACK_IMPORTED_MODULE_1_momentjs___default.a(this.receipt.created_at).format('YYYY-MM-DD  HH:mm');
    }
}), _defineProperty(_data$props$computed$, 'methods', {
    print: function print() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('tr', [_c('td', [_c('input', {
    ...
    domProps: {
      "textContent": _vm._s(_vm.createAt())
    }
