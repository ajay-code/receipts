...
Component.options.__file = "/Users/ajaysingh/code/laravel/app/resources/assets/js/components/admin/receipts/Receipts.vue"
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteReceipt: function deleteReceipt(ReceiptId) {
      ...
      var index = this.receipts.map(function (x) {
        return x.id;
      }).indexOf(ReceiptId);

      axios.get(this.scopeApi + '/receipts/delete/' + index).then(function (res) {
        _this4.$notify({
          group: 'notice',
          type: 'success',
          title: 'Success ',
...
var update = __webpack_require__(49)("66e28591", content, false);
