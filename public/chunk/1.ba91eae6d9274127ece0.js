...
/* harmony default export */ __webpack_exports__["default"] = (_data$props$computed$ = {
    ...
    computed: {
        ...
        createdAt: function createdAt() {
            return __WEBPACK_IMPORTED_MODULE_1_moment___default.a(this.receipt.created_at).format('YYYY-MM-DD  HH:mm');
        }
    },
    mounted: function mounted() {
...
}, _defineProperty(_data$props$computed$, 'computed', {}), _defineProperty(_data$props$computed$, 'methods', {
    print: function print() {
