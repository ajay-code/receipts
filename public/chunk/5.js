...
var update = __webpack_require__(132)("9b04eee8", content, false);
    ...
    toggleSelectAll: function toggleSelectAll() {
      ...
      if (this.selectAll) {
        _.each(this.response.records, function (record) {
          if (!_this5.selected.includes(record.id)) {
            _this5.selected.push(record.id);
          }
        });
      } else {
        this.selected = [];
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_vm._v("Delete")]) : _vm._e(), _vm._v(" "), (_vm.editing.id === record.id) ? [_c('a', {
      attrs: {
        "href": "#"
      },
      on: {
  ...
  }))]), _vm._v(" "), (_vm.response.pageInfo) ? _c('paginator', {
    attrs: {
